      ...
      <section className="py-20 bg-gradient-to-br from-primary/5 to-accent/10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-muted-foreground text-pretty mb-8">
            Begin your child's journey toward academic excellence and personal
            growth. We welcome students who are ready to be challenged and
            inspired.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              A straightforward process designed to get to know your child and
              family
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Complete our online application form with student information
            ...
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Schedule a tour to experience our campus and meet with our
                  admissions team.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Age-appropriate assessment to understand your child's academic
            ...
            <Card className="text-center">
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground text-sm">
                  Receive admission decision and enrollment information within
                  two weeks.
                </p>
              </CardContent>
            </Card>
                ...
                <div className="space-y-4">
                  ...
                  <div className="mt-4 p-4 bg-accent rounded-lg">
                    <p className="text-sm text-muted-foreground">
                      Tuition includes textbooks, technology, most field trips,
              ...
              <CardContent className="pt-6">
                ...
                <div className="space-y-4">
                  <p className="text-muted-foreground leading-relaxed">
                    ...
                    qualified students from receiving an excellent education.
                    Excellence Academy offers need-based financial aid to
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start gap-2">
                      ...
                      <span className="text-muted-foreground text-sm">
                        Over $2 million awarded annually
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-4 w-4 text-primary mt-1 flex-shrink-0" />
      ...
      >
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Take the first step toward joining our community of learners
          </p>
      ...
      <section className="py-20 bg-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Common questions about our admission process
            </p>
          </div>
          ...
          <div className="space-y-6">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Our average student-to-teacher ratio is 12:1, ensuring
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Yes, we provide bus transportation from several locations
                  throughout the metropolitan area. Routes are determined based
                  on enrollment each year.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  We offer over 50 clubs and activities including athletics,
                  arts, academic competitions, community service, and special
                  interest groups.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Yes, we accept transfer students throughout the year based on
                  availability. We work closely with families to ensure a smooth
                  transition.
                </p>
              </CardContent>
            </Card>
