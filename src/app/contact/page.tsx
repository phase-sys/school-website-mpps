            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <p className="text-muted-foreground text-xs mt-3">
                    IT support, device issues, online platform help
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Experience Excellence Academy firsthand with a personalized campus
            tour
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              <a href="mailto:admissions@excellenceacademy.edu">
                Email Admissions
              </a>
            </Button>
          </div>
          <p className="text-sm mt-6 opacity-75">
            Tours available Monday-Friday at 9:00 AM, 11:00 AM, and 2:00 PM
          </p>
        </div>
      </section>
